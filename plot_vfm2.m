...
plot(t_full_timedomain-t_start,delta_timedomain/pi*180,'LineStyle','--','linewidth',2.8,'color',[0.8500 0.3250 0.0980]);%':','linewidth',2,'color','black');%':','linewidth',2,'color',[0 0 0]);    hold on;
...
old_valley = 0.18;         % 当前谷值大约位置，按你图上估计
